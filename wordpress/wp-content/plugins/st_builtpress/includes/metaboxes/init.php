		...
		foreach ( $this->_meta_box['fields'] as $field ) {
			...
			switch ( $field['type'] ) {
				...
				case 'textarea_code':
					...
					break;
				case 'select':
					if( empty( $meta ) && !isset($_GET['post']) && !empty( $field['std'] ) ) $meta = $field['std'];
				...
				break;
				case 'st_meta_field':
					echo '<ul id="'. $field['id'] .'" class="cmb_meta_group">';
						if ( $meta != '' ) {
							foreach ($meta as $meta_key => $meta_val) {
								echo '
								<li class="meta-'. $meta_key .'">
									...
									<button class="button-secondary cmb_meta_delete">Delete</button>
								</li>';
							}
						}
						else {
					...
					echo '</ul>';
					echo '<button class="button-primary cmb_meta_add">Add More Meta</button>';
					echo $html;
				break;
				case 'st_social_icons':
						echo '<ul id="'. $field['id'] .'" class="cmb_social_group">';
							$getSocial = slicetheme_get_socials();
							unset($getSocial['rss']);
				...
				case 'st_image_gallery':
					...
					echo '<p class="cmb_metabox_description">', $field['desc'], '</p>';
					echo '<div id="', $field['id'], '_status" class="cmb_media_status cmb_sortable">';
					if ( $meta != '' ) {
