<!-- header -->
<?php $header_skin = builtpress_opt_page('header_transparent') ? 'transparent' : 'default'; ?>
<header id="header" class="header-skin-<?php echo esc_attr( $header_skin ); ?>" role="banner">
